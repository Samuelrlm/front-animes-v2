                ...
                <div className="p-4">
                    ...
                    <div className="flex space-x-2 mt-4">
                        ...
                        <button 
                            ...
                            className="bg-gradient-to-r from-purple-500 to-blue-500 hover:from-purple-600 hover:to-blue-600 text-white p-2 rounded-md transition-all duration-200 relative group"
